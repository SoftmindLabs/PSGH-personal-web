...
export default function HeroSection() {
  return (
    <section className="relative w-full">
      <div className="lg:hidden relative w-full min-h-[69vh] bg-[#6c6457]">
        ...
        <div className="relative z-10 flex flex-col min-h-[69vh]">
      ...
      <div className="hidden lg:block relative w-full min-h-[120vh] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col min-h-[120vh]">
          <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[40%] flex items-start justify-between text-white">
          ...
          <div className="flex items-center w-[95%] mx-auto justify-between min-h-screen">
          ...
          <div className="relative z-10 h-[21vh] flex items-end justify-center w-full">
            <h2
